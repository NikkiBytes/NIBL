...
def infotodict(seqinfo):
    ...
    # anat/
    t1 = create_key('anat/'+ subject+ '_T1w')


    # fmap/
    fmap_phase = create_key('fmap/' + subject + '_phasediff')
    fmap_magnitude = create_key('fmap/' + subject + '_magnitude')


    # func/
    rest = create_key('func/' + subject + '_task-rest_bold')
    run01 = create_key('func/' + subject + '_task-prob_run-1_bold')
    run02 = create_key('func/' + subject  + '_task-prob_run-2_bold')
    run03 = create_key('func/' + subject + '_task-prob_run-3_bold')
    run04 = create_key('func/'+ subject + '_task-prob_run-4_bold')
