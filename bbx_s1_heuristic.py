...
def infotodict(seqinfo):
    ...
    # anat/
    t1 = create_key('anat/sub-' + subject+ '_ses-1_T1w')


    # fmap/
    fmap_phase = create_key('fmap/' + subject + '_ses-1_phasediff')
    fmap_magnitude = create_key('fmap/' + subject + '_ses-1_magnitude')


    # func/
    rest = create_key('func/' + subject + '_ses-1_task-resting_bold')
    run01 = create_key('func/' + subject + '_ses-1_task-training_run-1_bold')
    run02 = create_key('func/' + subject  + '_ses-1_task-training_run-2_bold')
    run03 = create_key('func/' + subject + '_ses-1_task-training_run-3_bold')
    run04 = create_key('func/' + subject + '_ses-1_task-training_run-4_bold')
    run01_rl = create_key('func/'+ subject + '_ses-1_task-rl_run-1_bold')
    run02_rl = create_key('func/'+ subject + '_ses-1_task-rl_run-2_bold')
