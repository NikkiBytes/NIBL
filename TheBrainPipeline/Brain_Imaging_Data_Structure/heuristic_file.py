...
def infotodict(seqinfo):
    ...
    # func/
    rest = create_key('func/{subject}_{session}_task-resting_bold')
    run01 = create_key('func/{subject}_{session}_task-training_run-1_bold')
    run02 = create_key('func/{subject}_{session}_task-training_run-2_bold')
    run03 = create_key('func/{subject}_{session}_task-training_run-3_bold')
    run04 = create_key('func/{subject}_{session}_task-training_run-4_bold')
    run01_rl = create_key('func/{subject}_{session}_task-rl_run-1_bold')
    run02_rl = create_key('func/{subject}_{session}_task-rl_run-2_bold')
